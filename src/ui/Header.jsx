...
function Header() {
  return (
    <header className="sticky top-0 px-4 py-3 uppercase sm:px-6 shadow-md shadow-stone-600 font-playpen flex flex-col sm:flex-row justify-between items-center bg-backGround text-textColor z-10">
