...
function Button({ children, disabled, to, type }) {
  const base =
    "inline-block text-sm rounded-full bg-sky-500 font-semibold uppercase tracking-wide text-stone-100 transition-colors duration-300 hover:bg-sky-400 focus:bg-sky-300 focus:outline-none focus:ring focus:ring-sky-500 focus:ring-offset-2 disabled:cursor-not-allowed";
  const styles = {
