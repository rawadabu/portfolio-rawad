...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    project:
      "inline-block text-sm rounded-full hover:font-bold font-playpen uppercase tracking-wide transition-colors duration-300 focus:outline-none disabled:cursor-not-allowed px-4 py-2 md:px-5 md:py-2.5 text-fuchsia-500 underline",
    navbar:
      base +
