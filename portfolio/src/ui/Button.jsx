...
function Button({ children, disabled, to, type }) {
  const base =
    "inline-block text-sm rounded-full bg-fuchsia-700	 font-semibold uppercase tracking-wide text-stone-100 transition-colors duration-300 hover:bg-fuchsia-500	 focus:bg-fuchsia-500 focus:outline-none focus:ring focus:ring-fuchsia-500 focus:ring-offset-2 disabled:cursor-not-allowed";
  const styles = {
